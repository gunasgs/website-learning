...
const CTA = ({ tag1, tag2, tag3, button }) => {
    return (
        <Box sx={{ backgroundColor: "#705DED", mx: "auto", my: 5, borderRadius: 2, }} >
            <Grid sx={{ display: "flex", p: 6, justifyContent: "space-between", flexWrap: "wrap" }}>

                <Grid lg={6} color="white" >
                    {tag1 && <Typography variant='body1'>{tag1}</Typography>}
                    <Typography variant='h6' sx={{ py: 2 }} >{tag2}</Typography>
